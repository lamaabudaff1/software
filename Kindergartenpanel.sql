...
(23, 'حفل تكريم الطلبة يوم الثلاثاء 2 يونيو', '2021-01-21 20:07:29', '1'),
...
--
-- Table structure for table `gallerykindergarten`
--

CREATE TABLE `gallerykindergarten` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `gallerykindergarten`
--

INSERT INTO `gallerykindergarten` (`id`, `subject`, `images`, `created_at`) VALUES
...
--
-- Indexes for table `gallerykindergarten`
--
ALTER TABLE `gallerykindergarten`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `gallerykindergarten`
--
ALTER TABLE `gallerykindergarten`
