...
if (isset($_POST['gallerybtn'])) {
    ...
    if (file_exists("upload/" . $_FILES["gallery_image"]['name'])) {
        ...
        header('Location: gallerykindergarten.php');
    } else {

        $query = "INSERT INTO gallerykindergarten (subject , images) VALUES ('$subject' , '$images')";
        $query_run = mysqli_query($connection, $query);
        if ($query_run) {
...
if (isset($_POST['updategallerybtn'])) {
    ...
    $gallery_query = "SELECT * FROM gallerykindergarten WHERE id='$edit_id' ";
    ...
    $query = "UPDATE gallerykindergarten SET subject='$edit_subjectschool' , images='$image_data'  WHERE id='$edit_id'";
    $query_run = mysqli_query($connection, $query);
...
if (isset($_POST['deletegallery_btn'])) {
    ...
    $query = "DELETE FROM gallerykindergarten WHERE id='$id' ";
    $query_run = mysqli_query($connection, $query);
